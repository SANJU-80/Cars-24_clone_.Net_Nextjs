...
// Helper to extract brand and year from title
							...
							<div className="space-y-4">
								...
								<div>
									...
									<div className="space-y-2">
										{["Maruti", "Hyundai", "Honda", "Tata", "Toyota"].map(
											(brand) => (
										...
										return (
											...
											>
												...
												<div className="p-4">
													...
													{/* Maintenance Estimate Section */}
													{maintenance && (
														<div className="mt-2 text-xs text-blue-700 bg-blue-50 rounded p-2">
															<div>
																<strong>Est. Maintenance:</strong> ₹
																{maintenance.monthlyCost}/mo (
